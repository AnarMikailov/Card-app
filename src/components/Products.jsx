...
const Products = ({ name, img, price }) => {
  const [favorities, setFavorities] = useState(false);
  return (
    <>
      {/* <Link to="/products"> */}
      <div className="flex justify-between relative  flex-col p-2 m-2 shadow-lg w-72">
        <div
        ...
        <img
          className="w-[12rem] h-[12rem] self-center overflow-hidden"
          src={img}
          alt={name}
        />
